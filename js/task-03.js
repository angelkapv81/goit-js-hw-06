...
const liArray = images.map(
  (element) =>
    `<li class="images"><img src=${element.url} alt=${element.alt}></li>`
);

const htmlsString = liArray.join("");

ulElement.insertAdjacentHTML("afterbegin", htmlsString);
